#Embedded file name: /Users/versonator/Jenkins/live/output/Live/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Launch_Control/TouchOSC.py
...
class TouchOSC_EC4(ControlSurface):

    def __init__(self, c_instance):
        super(TouchOSC_EC4, self).__init__(c_instance)
        ...
        self.log_message(u'TouchOSC_EC4 script loaded')

    def disconnect(self):
        super(TouchOSC_EC4, self).disconnect()
    ...
    def _do_refresh_state(self):
        ...
        self.schedule_message(3, super(TouchOSC_EC4, self).refresh_state)
...
##This is the device mode that you'll want to make the changes to.
    def _init_device(self):
        make_button = partial(make_launch_control_button, channel=15)
...
## Changed to note/isPad because EC4 doesn't have CC+8 instant, it's toggle only at the time of scripting.
        ...
        for index in range(8):
            ...
            select_button.set_on_off_values(Colors.TOTAL_ON, Colors.LED_OFF)
...
##change to send top and bottom encoders
    ...
    def _init_modes(self):
        ...
        self._modes.add_mode(u'session', [partial(self._session.set_mixer, self._session_mixer),
         ...
         self._session,
         self._show_controlled_tracks_message])
       ##add self._selector and self._show_controlled_tracks_message to the mode properties of the mode 'device'
